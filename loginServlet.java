...
public class loginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			// response.getWriter().println(" you got here!(doPost,servlet)");
			...
			// session.getAttribute("facade") == null)) {
			switch (type) {
			case "Admin":
		...
		CouponSystemException e) {
			...
			// "if you see this message- u already have session and facade OR
			// failed the login and should be redirected to login");
